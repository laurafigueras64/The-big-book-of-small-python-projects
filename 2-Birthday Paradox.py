...
print('Out of 100.000 simulations of', numBDays, 'people there was a matching birthday in that group', simMatch, 'times. This means that', numBDays, 'have a', probability, '% chance of having a matching birthday in their group.')